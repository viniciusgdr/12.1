		...
		try {
			...
			switch (command) {
				...
				case 'botstatus': 
					...
					client.sendMessage(from, `Status :\n- *${loadedMsg}* Loaded Messages\n- *${groups.length}* Group Chats\n- *${chatIds.length - groups.length}* Personal Chats\n- *${chatIds.length}* Total Chats` , MessageType.text, { quoted: mek })
					break
				case 'randomhentai':
				...
				case 'vinicius':
					...
					break
				case 'leo':
					client.sendMessage(from, 'é lel', MessageType.text, { quoted: mek })
					break
				case 'porno':
					if (!isGroup) return reply(mess.only.group)
					client.sendMessage(from, 'aqui ne grp da mae joana nn\n seu filho da puta\n agora enfia esse ban', MessageType.text, { quoted: mek })
					client.groupRemove(from)
					break
				case 'kidbengala':
					client.sendMessage(from, '14033 aqui não tem moleza, sou pau pra toda obra', MessageType.text, { quoted: mek })
					break
				case 'comercial':
					client.sendMessage(from, 'gdr.com.br - XTREINOS 24H E CAMPS! \n tv.gdr.com.br - veja ao vivo teu pai ops a tv', MessageType.text, { quoted: mek })
					break
				case 'tué':
